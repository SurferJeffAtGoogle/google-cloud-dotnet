...
namespace Google.Cloud.Diagnostics.AspNetCore.Tests
{
    public class GoogleLoggerTest
    {
        ...
        private GoogleLogger GetLogger(
            ...
            string logName = null, MonitoredResource monitoredResource = null, LogTarget logTarget = null)
        {
            ...
            LoggerOptions options = LoggerOptions.Create(logLevel, logName, labels, monitoredResource);
