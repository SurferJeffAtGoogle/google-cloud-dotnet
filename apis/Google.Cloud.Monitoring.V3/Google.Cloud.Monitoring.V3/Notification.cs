...
namespace Google.Cloud.Monitoring.V3 {
  ...
  public sealed partial class NotificationChannel : pb::IMessage<NotificationChannel> {
    ...
    /// [`ListNotificationChannels`](/monitoring/api/ref_v3/rest/v3/projects.notificationChannels/list)
    /// or a [`GetNotificationChannel`](/monitoring/api/ref_v3/rest/v3/projects.notificationChannels/get),
    ...
    /// assumed that the channel works. If the channel is neither `VERIFIED`
    /// nor `UNVERIFIED`, it implies that the channel is of a type that
    /// does not require verification or that this specific channel has been
    /// exempted from verification because it was created prior to verification
    /// being required for channels of this type.
    ///
    /// This field cannot be modified using a standard
    /// [`UpdateNotificationChannel`](/monitoring/api/ref_v3/rest/v3/projects.notificationChannels/patch)
    /// operation. To change the value of this field, you must call
    /// [`VerifyNotificationChannel`](/monitoring/api/ref_v3/rest/v3/projects.notificationChannels/verify).
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
