...
namespace Google.Cloud.Monitoring.V3 {
  ...
  public sealed partial class AlertPolicy : pb::IMessage<AlertPolicy> {
    ...
    /// <summary>
    /// Identifies notification channels to which notifications should be sent
    /// when incidents are opened or closed, or when new violations occur on
    /// an already opened incident. The elements of this array correspond to
    /// `"name"` field in the `"NotificationChannel"`s that would be returned
    /// from the
    /// [google.monitoring.v3.NotificationChannelService.ListNotificationChannels]
    /// method. The syntax of the entries in this field are:
    ///
    ...
    public static partial class Types {
      ...
      public enum ConditionCombinerType {
        ...
        /// simultaneously. This combiner may be satisfied if all conditions are
      ...
      /// <summary>
      /// A string and a MIME type that describes the string's format.
      /// </summary>
      ...
      /// <summary>
      /// Conditions are true/false tests that determine when an alerting policy
      /// opens an incident.  If a condition evaluates to true, it signifies that
      /// something is wrong.
      /// </summary>
      public sealed partial class Condition : pb::IMessage<Condition> {
        ...
        /// method to update a policy, by including a condition name you cause the
        ...
        public void MergeFrom(Condition other) {
          ...
          switch (other.ConditionCase) {
            case ConditionOneofCase.ConditionThreshold:
              ConditionThreshold = other.ConditionThreshold;
              break;
            case ConditionOneofCase.ConditionAbsent:
              ConditionAbsent = other.ConditionAbsent;
              break;
          }
        ...
        public static partial class Types {
          ...
          public sealed partial class Trigger : pb::IMessage<Trigger> {
            ...
            public override int GetHashCode() {
              ...
              if (typeCase_ == TypeOneofCase.Percent) hash ^= Percent.GetHashCode();
              hash ^= (int) typeCase_;
              return hash;
            }
          ...
          public sealed partial class MetricThreshold : pb::IMessage<MetricThreshold> {
            ...
            /// are applied in the order specified. This field is similar to the
            /// one in the
            ...
            /// series that should be used as the denominator of a ratio should be
            /// compared with the threshold.  If present, the time series specified by
            /// `filter` will be used as the numerator.
            /// The filter is similar to the one that is specified in the
            /// [`MetricService.ListTimeSeries`
            /// request](/monitoring/api/ref_v3/rest/v3/projects.timeSeries/list) (that
            /// call is useful to verify the time series that will be retrieved /
            ...
            /// when aggregating multiple streams on each resource to a single
            /// stream for each resource or when aggregating streams across all
            /// members of a group of resources). When computing ratios, only one
            /// aggregation must be specified for the numerator and denominator. The
            /// denominator time series must have the same alignment as the
            /// time series specified by `filter`.
            ...
            /// time series that have been identified by `filter` and `aggregation`.
            /// </summary>
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
            ...
            public override int GetHashCode() {
              ...
              if (ThresholdValue != 0D) hash ^= ThresholdValue.GetHashCode();
